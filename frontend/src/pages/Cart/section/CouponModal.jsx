  ...
  const coupons = [
    {
      ...
      details: "Use Code PARTY and get FLAT 15% off on order above Rs.1500. No Upper Limit.",
      minOrder: 1500,
      discount: "15%",
      icon: "🎉",
    },
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-lg max-w-md w-full mx-4 max-h-96 overflow-y-auto">
        ...
        <div className="p-6 space-y-4">
          ...
          {/* Available Coupons */}
          <div>
            <h3 className="text-sm font-bold text-gray-900 mb-4">AVAILABLE COUPONS</h3>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mt-4">
            <p className="text-xs text-blue-800">
              💡 <strong>Tip:</strong> You can apply only one coupon per order. Choose the one that gives you the maximum savings!
            </p>
          </div>
        </div>
      </div>
