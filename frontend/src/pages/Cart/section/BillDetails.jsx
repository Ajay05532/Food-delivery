    ...
    <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-4">
      ...
      <div className="flex items-center justify-between text-sm">
        <div className="flex items-center gap-2">
          <span className="text-gray-600">Delivery Fee for 1.3 kms</span>
      ...
      <div className="flex items-center justify-between text-sm">
        ...
        <span className="font-semibold text-gray-900">₹{gstAndCharges}</span>
      </div>
        ...
        <>
          ...
          <div className="flex items-center justify-between text-sm bg-green-50 p-2 rounded">
            <div className="flex items-center gap-2">
              ...
              <span className="text-green-600 text-xs">Coupon applied</span>
            </div>
      ...
      <details className="text-xs text-gray-600">
        <summary className="cursor-pointer font-semibold text-gray-700 flex items-center gap-1 mb-2">
          Bill Details
          <ChevronDown size={16} />
        </summary>
